---
layout:     post
title:      19.SpringBoot学习笔记
subtitle:   @Conditional与自动配置报告
date:       2020-06-20
author:     Chen Xingxu
...
tags:
    - SpringBoot
---
# SpringBoot学习笔记（十九）--@Conditional与自动配置报告
...
其中 @ConditionalOnMissingBean 注解表示，只有缺失 CharacterEncodingFilter 这个组件，才给容器中添加组件，配置类里面的所有内容才生效。
...
进入 @ConditionalOnClass 这个注解，可以看到
...
底层是用 Spring 的 @Conditional 实现的。

### @Conditional 扩展注解

![](/img-post/2020-06-20-springboot/十九-01.jpg)
...
运行项目后， Console 中会显示 CONDITIONS EVALUATION REPORT
