---
layout:     post
title:      06.MyBatis学习笔记
subtitle:   Mybatis逆向工程（注解方式）
date:       2020-09-15
author:     Chen Xingxu
...
tags:
    - MyBatis
---
# 06.MyBatis学习笔记--Mybatis逆向工程（注解方式）
...
<generatorConfiguration>
    <context id="mybatisTables" targetRuntime="MyBatis3">
        ...
        <!-- 生成annotation形式的mapper形式的mapper -->
        <javaClientGenerator type="ANNOTATEDMAPPER" targetPackage="demo.yangxu.mybatis.mapper"
...
5. 由于数据库表中 desc 字段是 SQL 中的关键字，需要对 `demo.yangxu.mybatis.mapper.UserMapper` 进行修改，将 desc 改为 \`desc\`
   ...
   public interface UserMapper {
       ...
       @Insert({
           "insert into mybatis_user (username, age, ",
           "phone, `desc`)",
...
![](/img-post/2020-09-15-mybatis/06-01.png)
